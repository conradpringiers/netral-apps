/**
 * Static Header Renderer Component
 * Same as HeaderRenderer but without React hooks (for static HTML export)
 */

import { HeaderConfig } from '@/core/parser/netralParser';

interface StaticHeaderRendererProps {
  header: HeaderConfig;
}

export function StaticHeaderRenderer({ header }: StaticHeaderRendererProps) {
  switch (header.type) {
    case 'BigText':
      return (
